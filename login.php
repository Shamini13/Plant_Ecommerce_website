            ...
            <div class="row">
                <div class="col-sm-6 text-black">
                    ...
                    <div class="px-5 ms-xl-4">
                        ...
                        <span class="h1 fw-bold mb-0">Die Pflazen</span>
                    </div>

                    <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">

                        <form style="width: 23rem;" action="/web/login.php" method="post">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <label class="form-label" id="passin"  for="Password" >Password</label>
                            </div>
                            ...
                            <p>Don't have an account? <a href="C:\\Shamini\\winsem21-22\\web\\da\\regn.html"
                ...
                <div class="col-sm-6 px-0 d-none d-sm-block">
                    <img src="jonathan-borba-47whM1ZEvfU-unsplash (1).jpg"
